...
class _PdfScreenState extends State<PdfScreen> {
  ...
  void initState() {
    ...
    fromAsset('assets/sns_issue_114.pdf', 'sns_issue_114.pdf').then((f) {
      setState(() {
        sns_issue_114Pdf = f.path;
      });
    });
          ...
          builder: (BuildContext context) {
            return Column(
              children: <Widget>[
                ...
                TextButton(
                  child: Text('sns_issue_114Pdf'),
                  onPressed: () {
                    if (pathPDF.isNotEmpty) {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => PDFScreen(path: sns_issue_114Pdf),
                        ),
                      );
                    }
                  },
